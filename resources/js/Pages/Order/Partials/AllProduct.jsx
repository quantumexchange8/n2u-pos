...
import { DeleteIcon, DiscountIcon, MinusIcon, PlusIcon, ReturnIcon } from "@/Components/Outline";
import TextInput from "@/Components/TextInput";
import { formatAmount } from "@/Composables";
import { Badge, Card, Checkbox, Divider, Input, List, Radio, Spin } from "antd";
    ...
    const fetchProducts = async (category_id = 'all', page = 1) => {
        ...
        try {
            ...
            const response = await axios.get('/api/products/getProducts', {
                params: { category_id, page, limit: 12 }
            });
                    ...
                    <div className="flex flex-col max-h-[85vh] overflow-y-auto">
                        ...
                        <div className="py-4 flex flex-col gap-5">
                            <div className="py-2 px-4 flex flex-row gap-3">
                                <div className="max-w-[140px] w-full h-[140px] bg-neutral-50 flex items-center justify-center rounded-lg"></div>
                                <div className="w-full flex flex-col gap-3">
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <Button variant="white" size="md" iconOnly pill><DeleteIcon className='w-5 h-5' /></Button>
                                    </div> 
                                </div>
                            </div>
                            <div className="px-4">
